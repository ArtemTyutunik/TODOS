...
const Priorities = [
    ...
    {value: 2, Icon: () => <FlagIcon sx={{color: '#db561d'}}/>},
            ...
            <DropdownMenu anchorEl={anchorEl} handleClose={handleCloseMenu}>
                    <Box padding={'0 10px'}>
                        <Box m={'10px 0'}>
                            ...
                            <Box display={"flex"}>
                                {Priorities.map(Priority => <Box mr={'20px'} key={Priority.value}>
                                    <IconButton>
                                        <Priority.Icon/>
                                    </IconButton>
                                </Box>
                        ...
                        <List>
                            <ListItemButton sx = {{padding: '10px 0', marginBottom: '10px'}}>
                        ...
                        <Divider/>
                        <ListItemButton sx = {{padding: '10px 0', margin: '10px 0'}}>
